public class CustomStringMethods {
  ...
  // WRITE AND TEST THE METHODS BELOW
    ...
    public String funnyString(String str, int idx) {
      String idxLetter = str.substring(idx, idx + 1);
      String funStr = idxLetter + str + idxLetter;
      return funStr;
    }
    ...
    */
    public String halvesReversed(String myString) {
        ...
        String secHalf = myString.substring(myString.length() / 2);
        String reversed = secHalf + firstHalf;
        return reversed;
    }  
  ...
  */
  public String pigLatin(String orig) {
    ...
    String pigLatin = orig.substring(1) + firstLetter + "ay";
    return pigLatin;
  }
  ...
  */
  public String endUp(String myString, int numToCap) {
    ...
    if(len > numToCap) {
        String upperStr = myString.substring(len - numToCap);
        String newUpperStr = upperStr.toUpperCase();
        return myString.substring(0, len - numToCap) + newUpperStr;
    } else {
